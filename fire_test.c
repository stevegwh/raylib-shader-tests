...
int main(void)
{
    ...
    Texture2D texture = LoadTexture("../resources/textures/luos/Noise_Gradients/T_Random_29.png");
    Texture2D texture2 = LoadTexture("../resources/textures/luos/Noise_Gradients/T_Random_54.png");
